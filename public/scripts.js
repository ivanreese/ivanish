(function() {
  ...
  ready(function() {
    var canvas, k, len, ref, results;
    ref = document.querySelectorAll("canvas.js-stars");
    results = [];
    for (k = 0, len = ref.length; k < len; k++) {
      canvas = ref[k];
      if (window.getComputedStyle(canvas).display !== "none") {
        results.push((function(canvas) {
          var context, density, doRender, dpi, dscale, height, renderRequested, renderStars, requestRender, width;
          ...
          return renderStars = function() {
            var blueBlobs, c, decrease, h, i, increase, l, m, n, nBlueBlobs, nPixelStars, nPurpBlobs, nRedBlobs, nSmallGlowingStars, nStars, newWidth, o, pixelStars, purpleBlobs, q, r, r1, r2, redBlobs, ref1, ref2, ref3, ref4, ref5, ref6, s, scrollTop, smallGlowingStars, stars, starsPerfStart, start, sx, sy, u, v, w, x, y;
            scrollTop = document.body.scrollTop + document.body.parentNode.scrollTop;
            newWidth = parseInt(canvas.parentNode.offsetWidth) * dpi;
            if (width !== newWidth) {
              context = canvas.getContext("2d");
            ...
            if (redBlobs) {
              ...
              for (i = m = 0, ref1 = nRedBlobs; 0 <= ref1 ? m <= ref1 : m >= ref1; i = 0 <= ref1 ? ++m : --m) {
            ...
            if (purpleBlobs) {
              ...
              for (i = n = 0, ref2 = nPurpBlobs; 0 <= ref2 ? n <= ref2 : n >= ref2; i = 0 <= ref2 ? ++n : --n) {
            ...
            if (blueBlobs) {
              ...
              for (i = q = 0, ref3 = nBlueBlobs; 0 <= ref3 ? q <= ref3 : q >= ref3; i = 0 <= ref3 ? ++q : --q) {
            ...
            if (pixelStars) {
              ...
              for (i = u = 0, ref4 = nPixelStars; 0 <= ref4 ? u <= ref4 : u >= ref4; i = 0 <= ref4 ? ++u : --u) {
            ...
            if (stars) {
              ...
              for (i = v = 0, ref5 = nStars; 0 <= ref5 ? v <= ref5 : v >= ref5; i = 0 <= ref5 ? ++v : --v) {
                increase = i / nStars;
                decrease = 1 - increase;
            ...
            if (smallGlowingStars) {
              ...
              for (i = w = 0, ref6 = nSmallGlowingStars; 0 <= ref6 ? w <= ref6 : w >= ref6; i = 0 <= ref6 ? ++w : --w) {
