...
ready ()->
  ...
  doFullRender = ()-> renderStars(canvas, true)
  requestFullRender = ()-> requestAnimationFrame doFullRender
  doPartRender = ()-> renderStars(canvas, false)
  requestPartRender = ()-> requestAnimationFrame doPartRender
  
  requestFullRender()
  window.addEventListener "resize", requestFullRender
  window.addEventListener "scroll", requestPartRender

renderStars = (canvas, full)->
