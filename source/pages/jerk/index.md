...
<div class="hero">
  <img src="https://cdn.ivy.boo/jerk/jerk.jpg" alt="Cover art for the song — a photo of corn stocks, faded and yellow in the fall, with some hands mysteriously poking out from the back.">
</div>
...
> <p class="audio"><audio src="https://cdn.ivy.boo/jerk/jerk-post.mp3" controls preload="metadata"></audio></p>
...
<p class="audio">
  ...
  <audio src="https://cdn.ivy.boo/jerk/jerk-rough.mp3" controls preload="metadata"></audio>
</p>
...
<p class="audio">
  ...
  <audio src="https://cdn.ivy.boo/jerk/jerk-demo.mp3" controls preload="metadata"></audio>
</p>
...
<div class="hero normalize">
  <a href="https://mastodon.social/@spiralganglion/112062486570705551">
    <img alt="a mastodon post: normalize sharing whatever this song is going to turn into, before it's turned into that" src="https://cdn.ivy.boo/jerk/normalize.jpg">
  </a>
</div>
...
<div class="hero metro">
  <a href="/jerk/metronome">
    <img alt="screenshot of the metronome" src="https://cdn.ivy.boo/jerk/metro.png">
  </a>
</div>
...
<div class="hero moire">
  <img alt="Screenshot of the metronome recorded into Ableton Live, looking very much unlike a regular pattern, with wavy moire interference lines." src="https://cdn.ivy.boo/jerk/moire.png">
</div>
...
<p class="audio">
  <a download href="https://cdn.ivy.boo/jerk/jerk-nu-metal.mp3">Jerk (Nu Metal)</a>
  <audio src="https://cdn.ivy.boo/jerk/jerk-nu-metal.mp3" controls preload="metadata"></audio>
</p>

(If you'd like, [here's the full song](https://cdn.ivy.boo/jerk/jerk-nu-metal-full.mp3) in this unfinished nu metal state.)
...
<div class="hero lu">
  <img alt="Screenshot of a conversation with Lu, where I ask if I should release the song, save it for something, not release it. They tell me to save it, and release it, and not not release it." src="https://cdn.ivy.boo/jerk/lu.png">
</div>
...
<p class="audio">
  <a download href="https://cdn.ivy.boo/jerk/a2.mp3">2nd A-section</a>
  <audio src="https://cdn.ivy.boo/jerk/a2.mp3" controls preload="metadata"></audio>
</p>
...
<p class="audio">
  <a download href="https://cdn.ivy.boo/jerk/trash.mp3">Trash</a>
  <audio src="https://cdn.ivy.boo/jerk/trash.mp3" controls preload="metadata"></audio>
</p>
...
<div class="hero cymbals">
  <img alt="My drum kit, with a dozen-ish weird cymbals. The kit is decorated with little fake plants, a John Deere tractors flag, a small plastic bust of Darth Maul, bright orange flagging tape, a tiny boob, and other nonsense doodads." src="https://cdn.ivy.boo/jerk/cymbals.jpg">
...
<p class="audio">
  <a download href="https://cdn.ivy.boo/jerk/drag.mp3">Drag</a>
  <audio src="https://cdn.ivy.boo/jerk/drag.mp3" controls preload="metadata"></audio>
</p>
