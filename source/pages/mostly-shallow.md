...
![The camera got confused when taking this photo of Marcel, so his face is flat with a background exploding outward around him](https://cdn.ivy.boo/mostly-shallow/marcel.png)
![Worm-eye view of Taylor, with a disintegrating hand and big grin](https://cdn.ivy.boo/mostly-shallow/taylor.png)
![Forrest with a point-cloud finger held out in front of his face](https://cdn.ivy.boo/mostly-shallow/forrest.png)
