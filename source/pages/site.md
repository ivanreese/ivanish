...
It's compiled with a hand-written [build script](https://github.com/ivyreese/ivy.boo/blob/main/Cakefile). No frameworks. One library (for markdown).
...
The [&lt;head&gt;](https://github.com/ivyreese/ivy.boo/blob/main/source/head.html) is simple.
